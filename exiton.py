...
#
# bhw_energy_beta = np.array([4, 6, 10, 30, 60])
# energy_beta = np.array([-23.64551791561774, -23.74124824078548,  -23.78886289601704, -23.844218676966612, -24.07365231945558])
# fig = plt.figure()
...
x_moire_lims = 100
units = 'hartreebohr'  #'hartreebohr'  # or 'meVmeter'
