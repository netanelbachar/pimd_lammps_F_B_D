...
skiprows_in_Phi = 134  # 134 moire_onewell   harmonic_10 = 209
    ...
    for ind, seed in enumerate(seeds):
        ...
        for bhw in bhw_val:
            ...
            for i, p in enumerate(Nbeads):
                ...
                path_ = '/home/netanelb2/Desktop/Netanel/Research/exiton/moire_one_3p/'
                ...
                if p == max(Nbeads):  # Permutation Probability (Condensation)
                    if Natoms == 3:
                        l, p_l = permutation_prob_3(path + fname, beta, step_start,
                                                    Natoms)
                    elif Natoms == 10:
